      ...
      <div className="game-card">
        ...
        {!revealed ? (
          <div className="prompt-card">
            ...
            <button className="btn btn-primary" onClick={reveal}>Lösung zeigen</button>
          </div>
        ) : (
          <div className="feedback-card">
            ...
            <div className="rating-buttons">
              <button className="btn btn-yes" onClick={() => rate(true)}>✓ Ja</button>
              <button className="btn btn-no" onClick={() => rate(false)}>✗ Nein</button>
            </div>
          </div>
        )}
      </div>
